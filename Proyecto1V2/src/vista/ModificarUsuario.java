...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Administrar Usuario");
        ...
        lblDireccionImagen.setText("C:\\Users\\ferch\\Documents\\NetBeansProjects\\Proyecto1\\src\\images\\profilePhoto.png");
        ...
        btnModificar.setBackground(new java.awt.Color(38, 70, 83));
        btnModificar.setFont(new java.awt.Font("Montserrat", 0, 12)); // NOI18N
        btnModificar.setForeground(new java.awt.Color(241, 250, 238));
        btnModificar.setText("Modificar");
        btnModificar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(38, 70, 83)));
        ...
        pnlPrincipal.add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, 120, 30));
        ...
        btnEliminar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(38, 70, 83)));
        ...
        pnlPrincipal.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 500, 120, 30));
    ...
    public void modificarUsuario(Usuario usuario, boolean administrador) {
        ...
        txtAlias.setText(usuario.getAlias());
        txtTelefono.setText(usuario.getTelefono());
        lblDireccionImagen.setText(usuario.getRutaFotografia());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (correo.isEmpty() || nombre.isEmpty() || apellido.isEmpty() || contrasena.isEmpty() || dpi.isEmpty()
                ...
                || telefono.isEmpty() || rol.isEmpty() || kioscoAsociado.isEmpty()) {
            ...
            for (Usuario usuario : datos.usuarios) {
                ...
                if (usuario.getCorreo().equals(txtCorreo.getText())) {
                    ...
                    usuario.setRol(rol);
                    usuario.setRutaFotografia(rutaFoto);
                    usuario.setKioscoAsociado(kioscoAsociado);

                    this.dispose();
                    if (this.administrador == false) {
                        login.setVisible(true);
                        login.limpiar();
                        JOptionPane.showMessageDialog(null, "Se modificaron los datos de forma correcta\nPara ver los cambios será necesario reiniciar la sesion");
                    } else {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (correoUsuario.isEmpty()) {
            JOptionPane.showMessageDialog(null, "El campo correo debe contener información");
        } else {
            int respuesta = JOptionPane.showConfirmDialog(null, "Esta seguro de que desea eliminar su usuario, se eliminarán los datos de\nfacturacion, tarjetas y demas datos asociados. Este proceso es irreversible", "Confirmación de eliminación", JOptionPane.YES_NO_OPTION);
            if (respuesta == JOptionPane.YES_OPTION) {

                boolean existe = false;
                Iterator<Usuario> iter = datos.usuarios.iterator();
                while (iter.hasNext()) {
                ...
                if (existe) {
                    ...
                    if (this.administrador == false) {
                        login.setVisible(true);
                        login.limpiar();
                        JOptionPane.showMessageDialog(null, "Se eliminó el usuario, será necesario reiniciar");
                    } else {
                    ...
                    JOptionPane.showMessageDialog(null, "No se encontró ningun usuario con el correo ingresado");
                }
            } else {
                JOptionPane.showMessageDialog(null, "No se eliminará el usuario");
            }
        }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        if (this.administrador == false) {
            JOptionPane.showMessageDialog(null, "Es necesario reiniciar");
            login.setVisible(true);
            login.limpiar();
        }
